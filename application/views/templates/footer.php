...
<!-- End of Content Wrapper (topbar) -->

</div>
<!-- End of Page Wrapper (header) -->
...
<script>
    ...
    var myLineChart = new Chart(ctx, {
        ...
        data: {
            labels: ["Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Agu", "Sep", "Okt", "Nov", "Des"],
            datasets: [{
                data: JSON.parse("<?= json_encode($pd); ?>"),
                label: "Pendapatan",
                lineTension: 0.3,
                backgroundColor: "rgba(78, 115, 223, 0.05)",
                borderColor: "rgba(78, 115, 223, 1)",
                ...
                data: JSON.parse("<?= json_encode($pg); ?>"),
                label: "Pengeluaran",
                lineTension: 0.3,
                backgroundColor: "rgba(231, 74, 59, 0.05)",
                borderColor: "#e74a3b",
                ...
                data: JSON.parse("<?= json_encode($lb); ?>"),
                label: "Laba",
                lineTension: 0.3,
                backgroundColor: "rgba(78, 115, 223, 0.05)",
                borderColor: "#20c9a6",
    ...
    var myPieChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [<?= $total_transaksi; ?>, <?= $total_pengeluaran; ?>, <?= $laba; ?>],
                backgroundColor: ['#4e73df', '#e74a3b', '#20c9a6'],
