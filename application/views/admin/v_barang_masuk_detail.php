                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm text-right">
                            <a href="<?= base_url('Admin/Barang_Masuk/cetak_nota/') . $id_barang_masuk ?>" class="btn btn-primary" target="_blank"><i class="fa fa-print"></i> Nota</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover mt-3 mb-0">
                            ...
                            <tbody>
                                ...
                                foreach ($detail as $row) : ?>
                                    <tr>
                                        ...
                                        <td align="right"><?= format_uang2($row->harga_masuk) ?></td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right"><?= format_uang2($barangmasuk->total) ?></th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
