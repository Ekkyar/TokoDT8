        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-2 mb-4 mb-md-0">
                    ...
                    <a href="<?= base_url('Kasir/Profil/edit'); ?>" class="btn btn-sm btn-block btn-primary"><i class="fa fa-edit"></i> Edit Profil</a>
                    <a href="<?= base_url('Kasir/Profil/ubahpassword'); ?>" class="btn btn-sm btn-block btn-primary"><i class="fa fa-lock"></i> Ubah Password</a>
                </div>
                <div class="col-md-10">
                    <table class="table">
                        <tr>
